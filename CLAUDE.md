...
- **หากมีการแก้ไข/เพิ่มเรื่อง design ที่สำคัญ** (เช่น เพิ่มกราฟ/component ใหม่, เปลี่ยน layout, ปรับ UI ตาราง) ให้ทำ **preview/mockup ตัวอย่างมาให้ user ดูก่อนเสมอ** แล้วให้ user เลือก/ตัดสินใจก่อนลงมือเขียนโค้ดจริง — ใช้ visualize tool ทำ mockup เทียบหลายแบบ เพื่อให้เห็นภาพชัดเจน (การแก้เล็กน้อย เช่น แก้สี/ข้อความ/bug ไม่ต้องทำ preview)
